<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-black leading-tight text-imk-600 sm:text-3xl">Kelola Berita</h2>
                <p class="mt-1 text-sm text-gray-600">Kelola semua artikel berita yang tampil di website</p>
            </div>
        ...
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
                <div class="flex items-center justify-between gap-3 border-b border-gray-100 px-4 py-4 sm:px-5">
                    <div>
                        <h3 class="text-base font-bold text-imk-600">Daftar Berita</h3>
                        <p class="mt-0.5 text-xs text-gray-600">{{ $news->count() }} artikel</p>
                    </div>
                </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-5 py-14 text-center">
                                        ...
                                        <p class="mt-3 text-sm font-medium text-gray-800">Belum ada berita yang
                                            ditambahkan.</p>
                                        <a href="{{ route('admin.news.create') }}"
