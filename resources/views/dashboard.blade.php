    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('register') }}"
                class="px-5 py-2.5 bg-imk-600 text-white font-bold rounded-full hover:bg-imk-700 transition shadow-sm flex items-center gap-2 text-sm">
            ...
            <div class="bg-white rounded-[39px] shadow-xl p-6 md:p-10 lg:p-16 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-gray-600 text-lg">
                        {{ __("Anda telah login ke sistem. Silakan pilih menu di bawah ini untuk mengelola konten website.") }}
                    </p>

                    @if(session('success'))
                        <div
                            class="mt-6 bg-emerald-50 border border-emerald-200 text-emerald-700 px-6 py-4 rounded-2xl flex items-center gap-3">
                    ...
                    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <a href="{{ route('admin.news.index') }}"
                            class="group block p-6 bg-gray-50 rounded-3xl border border-gray-100 hover:border-imk-200 hover:shadow-lg transition duration-300 transform hover:-translate-y-1">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-14 h-14 bg-imk-100 text-imk-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition duration-300 shrink-0">
                                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9.5a2 2 0 00-.586-1.414l-4.5-4.5A2 2 0 0012.586 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14z">
                                        </path>
                                    </svg>
                                </div>
                                <div>
                        ...
                        <a href="{{ route('admin.settings.edit') }}"
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 class="text-xl font-bold text-[#051F20]">Pengaturan Beranda</h4>
                                    <p class="text-gray-500 text-sm mt-1">Ubah info kontak, sosial media serta foto
                                        struktur pada halaman beranda.</p>
                                </div>
                            </div>
                        </a>
